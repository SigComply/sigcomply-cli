// Package cmd is the CLI entry. M6 wires `sigcomply check` and
// `sigcomply version`; the post-M6 work plan adds the auditor-facing
// `sigcomply report` and (later) `build` + `init-ci`.
package cmd
