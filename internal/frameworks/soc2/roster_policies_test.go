...
func TestRosterPolicies_ShapeAndControls(t *testing.T) {
	...
	linked.control, linked.severity, linked.quantifier = "CC6.2", core.SeverityHigh, core.QuantifierAll
	inactive.control, inactive.severity, inactive.quantifier = "CC6.2", core.SeverityCritical, core.QuantifierNone
	want := map[string]rosterShape{
		"soc2.cc6.2.accounts_linked_to_roster":                 linked,
		"soc2.cc6.2.no_active_accounts_for_inactive_personnel": inactive,
	}
