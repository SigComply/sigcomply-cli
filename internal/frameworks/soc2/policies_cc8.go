...
func cc8Policies() []core.Policy {
	return []core.Policy{
		autoPolicy{
			id: "soc2.cc8.1.default_branch_protected", control: ctrlCC81, severity: core.SeverityHigh, category: catChangeManagement, cadence: cadenceDaily,
		...
		autoPolicy{
			id: "soc2.cc8.1.required_code_reviews", control: ctrlCC81, severity: core.SeverityHigh, category: catChangeManagement, cadence: cadenceDaily,
			accepts: []string{etGitRepository},
		...
		autoPolicy{
			id: "soc2.cc8.1.no_force_push_to_main", control: ctrlCC81, severity: core.SeverityMedium, category: catChangeManagement, cadence: cadenceDaily,
			accepts: []string{etGitRepository},
		...
		autoPolicy{
			id: "soc2.cc8.1.signed_commits_required", control: ctrlCC81, severity: core.SeverityLow, category: catChangeManagement, cadence: cadenceDaily,
			accepts: []string{etGitRepository},
		...
		autoPolicy{
			id: "soc2.cc8.1.dependabot_alerts_enabled", control: ctrlCC81, severity: core.SeverityMedium, category: catChangeManagement, cadence: cadenceDaily,
			accepts: []string{etGitRepository},
		...
		autoPolicy{
			id: "soc2.cc8.1.code_scanning_enabled", control: ctrlCC81, severity: core.SeverityMedium, category: catChangeManagement, cadence: cadenceDaily,
			accepts: []string{etGitRepository},
		...
		autoPolicy{
			id: "soc2.cc8.1.dismiss_stale_reviews", control: ctrlCC81, severity: core.SeverityLow, category: catChangeManagement, cadence: cadenceDaily,
			accepts: []string{etGitRepository},
		...
		autoPolicy{
			id: "soc2.cc8.1.require_code_owner_reviews", control: ctrlCC81, severity: core.SeverityLow, category: catChangeManagement, cadence: cadenceDaily,
			accepts: []string{etGitRepository},
...
func cc6SecretHygienePolicies() []core.Policy {
	return []core.Policy{
		autoPolicy{
			id: "soc2.cc6.5.secret_scanning_enabled", control: ctrlCC65, severity: core.SeverityHigh, category: catDataProtection, cadence: cadenceDaily,
			accepts: []string{etGitRepository},
		...
		autoPolicy{
			id: "soc2.cc6.5.push_protection_enabled", control: ctrlCC65, severity: core.SeverityMedium, category: catDataProtection, cadence: cadenceDaily,
			accepts: []string{etGitRepository},
...
func cc8ChangeEvidencePolicies() []core.Policy {
	return []core.Policy{
		autoPolicy{
			id: "soc2.cc8.1.changes_independently_approved", control: ctrlCC81, severity: core.SeverityHigh, category: catChangeManagement, cadence: cadenceDaily,
		...
		autoPolicy{
			id: "soc2.cc8.1.changes_passed_checks", control: ctrlCC81, severity: core.SeverityMedium, category: catChangeManagement, cadence: cadenceDaily,
			accepts: []string{etPullRequest},
		...
		autoPolicy{
			id: "soc2.cc8.1.approval_precedes_merge", control: ctrlCC81, severity: core.SeverityHigh, category: catChangeManagement, cadence: cadenceDaily,
			accepts: []string{etPullRequest},
