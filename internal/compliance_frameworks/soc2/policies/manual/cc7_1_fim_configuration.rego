...
violations contains violation if {
	...
	violation := {
		...
		"reason": sprintf("File Integrity Monitoring Configuration for period %s is overdue and not uploaded. Expected at: %s", [input.data.period, input.data.expected_uri]),
		"details": {
