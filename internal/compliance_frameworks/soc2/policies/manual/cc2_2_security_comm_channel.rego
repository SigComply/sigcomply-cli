...
violations contains violation if {
	...
	violation := {
		...
		"reason": sprintf("Security Communication Channel Evidence for period %s is overdue and not uploaded. Expected at: %s", [input.data.period, input.data.expected_uri]),
		"details": {
