package sigcomply.soc2.cc2_1_config_recorder_test

import data.sigcomply.soc2.cc2_1_config_recorder

test_not_all_supported if {
	result := cc2_1_config_recorder.violations with input as {
