package sigcomply.soc2.pi1_4_cloudwatch_log_kms_test

import data.sigcomply.soc2.pi1_4_cloudwatch_log_kms

test_no_kms if {
	result := pi1_4_cloudwatch_log_kms.violations with input as {
