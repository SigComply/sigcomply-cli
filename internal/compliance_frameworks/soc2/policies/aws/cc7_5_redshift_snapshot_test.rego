package sigcomply.soc2.cc7_5_redshift_snapshot_test

import data.sigcomply.soc2.cc7_5_redshift_snapshot

test_no_snapshots if {
	result := cc7_5_redshift_snapshot.violations with input as {
