...
|---|---|---|---|
| `soc2` | SOC 2 — 2017 Trust Services Criteria | Production-ready, **default** | 43 / 43 criteria have a check — 16 automated, 27 manual-only. 139 policies: 89 automated + 50 manual catalog entries. |
